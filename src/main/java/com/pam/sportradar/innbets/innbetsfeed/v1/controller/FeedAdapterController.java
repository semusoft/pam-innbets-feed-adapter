package com.pam.sportradar.innbets.innbetsfeed.v1.controller;

import com.pam.sportradar.innbets.innbetsfeed.v1.service.FeedAdapterXMLParserService;
...
public class FeedAdapterController {
    ...
    public FeedAdapterController(FeedAdapterXMLParserService feedAdapterXMLParserService) {
    ...
    public ResponseEntity<List<Category>> getCategoriesBySport(
            @Parameter(description = "Language code", example = "en") @PathVariable("lang") String language,
        ...
        try {
            ...
            return ResponseEntity.ok(categories.getCategories());
        } catch (Exception ex) {
    ...
    @GetMapping(value = "/{lang}/descriptions/market/variant", produces = APPLICATION_JSON_VALUE)
